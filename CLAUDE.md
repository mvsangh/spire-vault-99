...
- Password format: `<username>99` (e.g., jake99, amy99)
...
**Deployment Mode:** Dev mode (NOT for production)
- In-memory storage (data lost on pod restart)
- Auto-unsealed (no manual unseal)
- Root token: "root"
- Image: `quay.io/openbao/openbao:2.0.1`

**Planned Configuration (Sprint 4):**
- Cert auth method for backend workload authentication
